...
exports.AddRatingUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom.error");
const constants_1 = require("../../../shared/constants");
let AddRatingUseCase = class AddRatingUseCase {
    constructor(_ratingRepo, _bookingRepo) {
        this._ratingRepo = _ratingRepo;
    ...
    execute(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingRating = yield this._ratingRepo.findByBookingId(bookingId);
            if (existingRating) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.REQUEST_ALREADY_SUBMITTED, constants_1.HTTP_STATUS.CONFLICT);
            }
...
exports.AddRatingUseCase = AddRatingUseCase;
exports.AddRatingUseCase = AddRatingUseCase = __decorate([
