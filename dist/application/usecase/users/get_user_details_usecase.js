...
const getUserDetailsMapper_1 = require("../../mappers/getUserDetailsMapper");
let GetUserDetailsUseCase = class GetUserDetailsUseCase {
    ...
    execute(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const userDetails = yield this._clientRepository.findOne({
                userId: userId,
            });
            if (!userDetails) {
                throw new custom_error_1.CustomError(constants_1.ERROR_MESSAGES.USER_NOT_FOUND, constants_1.HTTP_STATUS.BAD_REQUEST);
            }
            return (0, getUserDetailsMapper_1.mapGetUserDetails)(userDetails);
        });
    }
};
