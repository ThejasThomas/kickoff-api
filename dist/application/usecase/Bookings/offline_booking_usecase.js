...
exports.OfflineBookingUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const custom_error_1 = require("../../../domain/utils/custom.error");
const constants_1 = require("../../../shared/constants");
const getBookingapper_1 = require("../../mappers/getBookingapper");
let OfflineBookingUseCase = class OfflineBookingUseCase {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!bookData.slots || !bookData.slots.length) {
                    throw new custom_error_1.CustomError("No slots selected", constants_1.HTTP_STATUS.BAD_REQUEST);
                }
                ...
                for (const slot of bookData.slots) {
                    ...
                    const savedBooking = yield this._bookingRepository.save(newBooking);
                    const mappedBooking = (0, getBookingapper_1.mapBookingDTO)(savedBooking);
...
exports.OfflineBookingUseCase = OfflineBookingUseCase;
exports.OfflineBookingUseCase = OfflineBookingUseCase = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("IBookingRepository")),
    __metadata("design:paramtypes", [Object])
], OfflineBookingUseCase);
