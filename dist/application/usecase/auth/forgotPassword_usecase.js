...
let ForgotPasswordUseCase = class ForgotPasswordUseCase {
    constructor(_clientRepository, _turfOwnerRepository, _adminRepository, _emailService, _tokenService, _redisTokenRepository) {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ email, role }) {
            ...
            yield this._emailService.sendResetEmail(email, "KickOFF - Reset your password", resetUrl);
        });
    }
};
